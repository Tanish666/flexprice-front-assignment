        ...
        {tierMode === TIER_MODE.VOLUME && (
          <div className="bg-blue-50 p-3 rounded-md">
            <div className="text-sm text-blue-800">
              <strong>Volume Mode:</strong> All {usageQuantity} units charged at
              the highest tier rate of {currencySymbol}
        ...
        {tierMode === TIER_MODE.SLAB && (
          <div className="bg-green-50 p-3 rounded-md">
            <div className="text-sm text-green-800">
              <strong>Slab Mode:</strong> Each tier range priced separately and
              summed.
            </div>
          </div>
        )}
